...
function purchaseClicked() {
    ...
    alert('Order confirmed \n Fill in payment information in checkout page.')
...
function addItemToCart(title, price, imageSrc) {
    ...
    cartRow.classList.add('cart-row')
		alert('Item added to cart. click view cart to view the items!!');
    var cartItems = document.getElementsByClassName('cart-items')[0]
    ...
    var cartRowContents = `
        <tr class="cart-item cart-column">
        ...
        <td class="cart-quantity cart-column">
           <input class="cart-quantity-input" type="number" value="1" min=1 max=100>
